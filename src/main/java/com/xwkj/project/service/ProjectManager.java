...
public interface ProjectManager {
     ...
     * @return
     */
    String addProject(String name, String attributes, String content, String expireAt, String uid, HttpSession session);
     ...
     * @return
     */
    boolean modifyProject(String pid, String name, String attributes, String content, String expireAt, HttpSession session);
